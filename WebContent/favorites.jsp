...
<html>
	<head>
		...
		<script>
			function getUser() { //get the username for this Session
				var xhttp = new XMLHttpRequest();
				//getting correct responses from servlet ... need to get stuff sorted in the XML
				xhttp.open("GET", "favoriteFunctions?request=getname", true);
				xhttp.send();
				xhttp.onreadystatechange = function () {
					if(this.readyState == XMLHttpRequest.DONE){
						document.getElementById("results-header").innerHTML = this.responseText + "'s Favorites:";
					}							    
				}	
			}
			function getFavorites() {
				var xhttp = new XMLHttpRequest();
				//getting correct responses from servlet ... need to get stuff sorted in the XML
				xhttp.open("GET", "favoriteFunctions?request=get", true);
				xhttp.send();
				xhttp.onreadystatechange = function () {
					if(this.readyState == XMLHttpRequest.DONE){
						//return all the favorites through a print writer... they have already been formatted in the backend
						document.getElementById("resultsHere").innerHTML = this.responseText;			    
					}	
				}
			}
		</script>
		<script>
			...
			function sortbyAZ() {
				var xhttp = new XMLHttpRequest();
				xhttp.open("GET", "favoriteFunctions?request=sort&type=az", true);
				xhttp.send();
				xhttp.onreadystatechange = function () {
					if(this.readyState == XMLHttpRequest.DONE){
						//return all the favorites through a print writer... they have already been formatted in the backend
			...
			function sortbyZA() {
				var xhttp = new XMLHttpRequest();
				xhttp.open("GET", "favoriteFunctions?request=sort&type=za", true);
				xhttp.send();
				xhttp.onreadystatechange = function () {
					if(this.readyState == XMLHttpRequest.DONE){
						//return all the favorites through a print writer... they have already been formatted in the backend
			...
			function sortbyHigh() {
				var xhttp = new XMLHttpRequest();
				xhttp.open("GET", "favoriteFunctions?request=sort&type=highlow", true);
				xhttp.send();
				xhttp.onreadystatechange = function () {
					if(this.readyState == XMLHttpRequest.DONE){
						//return all the favorites through a print writer... they have already been formatted in the backend
			...
			function sortbyLow() {
				var xhttp = new XMLHttpRequest();
				//getting correct responses from servlet ... need to get stuff sorted in the XML
				xhttp.open("GET", "favoriteFunctions?request=sort&type=lowhigh", true);
				xhttp.send();
				xhttp.onreadystatechange = function () {
					if(this.readyState == XMLHttpRequest.DONE){
						//return all the favorites through a print writer... they have already been formatted in the backend
			...
			function sortbyMost() {
				var xhttp = new XMLHttpRequest();
				//getting correct responses from servlet ... need to get stuff sorted in the XML
				xhttp.open("GET", "favoriteFunctions?request=sort&type=most", true);
				xhttp.send();
				xhttp.onreadystatechange = function () {
					if(this.readyState == XMLHttpRequest.DONE){
						//return all the favorites through a print writer... they have already been formatted in the backend
			...
			function sortbyLeast() {
				var xhttp = new XMLHttpRequest();
				//getting correct responses from servlet ... need to get stuff sorted in the XML
				xhttp.open("GET", "favoriteFunctions?request=sort&type=least", true);
				xhttp.send();
				xhttp.onreadystatechange = function () {
					if(this.readyState == XMLHttpRequest.DONE){
						//return all the favorites through a print writer... they have already been formatted in the backend
	...
	<body onload="sessionCheck(); getUser(); getFavorites();">
					...
					<div class="col-sm">
						<div class="dropdown">
							  ...
							  <div class="dropdown-content">
							  	<p onclick="sortbyAZ()">A-Z</p>
							    <p onclick="sortbyZA()">Z-A</p>
							    <p onclick="sortbyHigh()">Highest Rated</p>
							    <p onclick="sortbyLow()">Lowest Rated</p>
							    <p onclick="sortbyMost()">Most Recent</p>
							    <p onclick="sortbyLeast()">Least Recent</p>
  							</div>
						</div>
					</div>
				</div>
